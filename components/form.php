...
<div id="form">
    ...
    <form action="mail.php" method="post" name="form" id="myForm">
        ...
        <select name="course" class="form-control" id="courseSelect" required>
                            ...
                            <option value="DBA">DBA+MBA in Finance</option>
                            <option value="DBA">DBA+MBA in Leadership</option>
                        </select>
		...
		<input type="hidden" name="source" id="source" class="form-control" value="Edgewood LP">
