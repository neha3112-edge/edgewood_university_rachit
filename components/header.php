...
})(window,document,'script','dataLayer','GTM-M5DP8TFZ');</script>
<!-- End Google Tag Manager -->

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-LG0YEDJ00D"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-LG0YEDJ00D');
</script>
    ...
    <div class="container">
        <nav class="nav">
            ...
            <div class="nav-header">
                <div class="nav-title">
                    <a href="https://edgewood.distanceeducationschool.in/" id="logo-link">  
